  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
				...
				<form method="POST" action="paginas/adicionarDados/adicionarLimpeza.php">
        ...
        <button type="submit"  name="AdicionarLimpeza" class="btn btn-warning">Adicionar</button>
      </div>
    ...
    <table class="table table-striped" id="minhaTabela">
                        ...
                        <?php
                          require 'conn.php';
                          $query = mysqli_query($conn, "SELECT * FROM `mlimpeza`") or die(mysqli_error());
                        ...
                        ?>
                                    ...
                                    <tr>
                                      ...
                                      <td><?php echo $fetch['validade']?></td>
                                      <td><?php echo $fetch['qtdMinima']?></td>

                                        <td><a href="paginas/delete/deleteLimpeza.php?deletar=<?php echo $fetch['id']?>" class="btn btn-danger" onclick="return confirm('Deseja realmente deletar o Registro')"><i class="fa fa-trash-o"></i></a></td>
                      ...
                      <?php
                        ...
                        include 'modal_update/modalLimpeza.php';
                         include 'retirarUpdate/retirarLimpeza.php';
                          };
...
<form method="post" action="paginas/PDF/limpezaPDF.php"  >
...
<?php
 include 'paginas/PDF/conexao/conexaolimpeza.php'
