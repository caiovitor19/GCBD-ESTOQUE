   ...
   <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Material de Processamento</h3>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
				...
				<form method="POST" action="paginas/adicionarDados/adicionarProcessamento.php">
        ...
        <button type="submit"  name="AdicionarProcessamento" class="btn btn-warning">Adicionar</button>
      </div>
    ...
    <table class="table table-striped" id="minhaTabela">
                        ...
                        <?php
                          require 'conn.php';
                          $query = mysqli_query($conn, "SELECT * FROM `mprocessamento`") or die(mysqli_error());
                        ...
                        ?>
                                    ...
                                    <tr>
                                      ...
                                      <td><?php echo $fetch['qtdMinima']?></td>
                                        ...
                                        <td><a href="paginas/delete/deleteProcessamento.php?deletar=<?php echo $fetch['id']?>" class="btn btn-danger" onclick="return confirm('Deseja realmente deletar o Registro')"><i class="fa fa-trash-o"></i></a></td>
                      ...
                      <?php
                        ...
                        include 'modal_update/modalProcessamento.php';
                         include 'retirarUpdate/retirarProcessamento.php';
                          };
...
<form method="post" action="paginas/PDF/processamentoPDF.php"  >
...
<?php
 include 'paginas/PDF/conexao/conexaoprocessamento.php'
